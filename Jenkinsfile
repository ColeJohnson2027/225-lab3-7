pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/john2027'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/ColeJohnson2027/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('john2027-sp26')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.229.168 \
